...
var scheduledAarray = [15, 8, 12, 4, 22, 25, 36, 10, 17, 39, 19, 28, 9, 9, 9, 9, 9, 9, 9, 9, 25, 36, 10, 17, 39, 19, 28, 6, 7, 30, 8];
var completedArray = [6, 2, 4, 1, 10, 5, 12, 4, 12, 17, 11, 26, 8, 12, 4, 22, 25, 36, 10, 17, 39, 19, 28, 9, 9, 9, 9, 9, 9, 9, 9];
var scheduledObj = { name: "Scheduled", series: [] };
var completedObj = { name: "Completed", series: [] };
for (var i = 1; i <= 31; i++) {
