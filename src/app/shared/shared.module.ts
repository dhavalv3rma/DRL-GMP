...
import { PrimeDragulaDirective } from '../admin/sequences/prime-dragula.directive';
import {
...
@NgModule({
  ...
  exports: [
    ...
    SplitButtonModule, ButtonModule, DropdownModule, AccordionModule,
    ProgressBarModule, ConfirmDialogModule,
    TooltipModule, jqxKanbanComponent,PrimeDragulaDirective 
  ],
  declarations: [jqxKanbanComponent, PrimeDragulaDirective]
})
