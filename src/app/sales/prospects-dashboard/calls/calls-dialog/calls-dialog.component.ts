...
@Component({
  selector: 'app-calls-dialog',
  templateUrl: './calls-dialog.component.html',
  styleUrls: ['./calls-dialog.component.scss']
})
export class CallsDialogComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<CallsDialogComponent>,
